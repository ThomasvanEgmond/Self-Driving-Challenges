...
void setup(){
    ...
    if (LORA_SENDER) {
      PS4.attach(onEvent);
      PS4.begin("f0:b6:1e:79:0b:4d"); // make this the mac-adress of the bluetooth adapter that your ps4 controller was last connected to, like your laptop. This will pretend to be your laptop, so turn off your laptop bluetooth.
    }
    while (!Serial);
